...
namespace ReportBuilder.Migrations
{
    /// <inheritdoc />
    public partial class AddReportBuilder : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RB_ReportDefinitions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    Description = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    SqlQuery = table.Column<string>(type: "character varying(50000)", maxLength: 50000, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RB_ReportDefinitions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RB_ReportColumns", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RB_ReportColumns_RB_ReportDefinitions_ReportDefinitionId",
                        column: x => x.ReportDefinitionId,
                        principalTable: "RB_ReportDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "RB_ReportParameters",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ReportDefinitionId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RB_ReportParameters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RB_ReportParameters_RB_ReportDefinitions_ReportDefinitionId",
                        column: x => x.ReportDefinitionId,
                        principalTable: "RB_ReportDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RB_ReportPermissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RB_ReportPermissions_RB_ReportDefinitions_ReportDefinitionId",
                        column: x => x.ReportDefinitionId,
                        principalTable: "RB_ReportDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "RB_ColumnPermissions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ReportColumnId = table.Column<Guid>(type: "uuid", nullable: false),
                    RoleName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    IsVisible = table.Column<bool>(type: "boolean", nullable: true),
                    IsFilterable = table.Column<bool>(type: "boolean", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RB_ColumnPermissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RB_ColumnPermissions_RB_ReportColumns_ReportColumnId",
                        column: x => x.ReportColumnId,
                        principalTable: "RB_ReportColumns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RB_ColumnPermissions_ReportColumnId",
                table: "RB_ColumnPermissions",
                column: "ReportColumnId");

            migrationBuilder.CreateIndex(
                name: "IX_RB_ReportColumns_ReportDefinitionId",
                table: "RB_ReportColumns",
                column: "ReportDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_RB_ReportDefinitions_Name",
                table: "RB_ReportDefinitions",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_RB_ReportParameters_ReportDefinitionId",
                table: "RB_ReportParameters",
                column: "ReportDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_RB_ReportPermissions_ReportDefinitionId_RoleName",
                table: "RB_ReportPermissions",
