...
{
    [DbContext(typeof(ReportBuilderDbContext))]
    partial class ReportBuilderDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReportBuilder.Reports.ColumnPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ReportColumnId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RB_ColumnPermissions", (string)null);
                });

            modelBuilder.Entity("ReportBuilder.Reports.ReportColumn", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RB_ReportColumns", (string)null);
                });

            modelBuilder.Entity("ReportBuilder.Reports.ReportDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RB_ReportDefinitions", (string)null);
                });

            modelBuilder.Entity("ReportBuilder.Reports.ReportParameter", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RB_ReportParameters", (string)null);
                });

            modelBuilder.Entity("ReportBuilder.Reports.ReportPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RB_ReportPermissions", (string)null);
                });

            modelBuilder.Entity("ReportBuilder.Students.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RB_Students", (string)null);
                });
            ...
            modelBuilder.Entity("ReportBuilder.Reports.ColumnPermission", b =>
                {
                    b.HasOne("ReportBuilder.Reports.ReportColumn", null)
            ...
            modelBuilder.Entity("ReportBuilder.Reports.ReportColumn", b =>
                {
                    b.HasOne("ReportBuilder.Reports.ReportDefinition", null)
                        .WithMany("Columns")
