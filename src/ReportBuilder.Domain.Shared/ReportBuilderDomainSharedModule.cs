...
public class ReportBuilderDomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ReportBuilderDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ReportBuilderResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/ReportBuilder");

            options.DefaultResourceType = typeof(ReportBuilderResource);
        ...
        {
            options.MapCodeNamespace("ReportBuilder", typeof(ReportBuilderResource));
        });
    }
}
