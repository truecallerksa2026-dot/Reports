...
```
127.0.0.1 reportbuilder-local-web
127.0.0.1 reportbuilder-local-webgateway
127.0.0.1 reportbuilder-local-authserver
```
...
Now, you can browse the URL: `https://reportbuilder-local-web`
